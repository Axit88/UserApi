...
func (c *testApiClient) AddUser(ctx context.Context, in *AddUserInput, opts ...grpc.CallOption) (*AddUserOutput, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.TestApi/AddUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testApiClient) GetUser(ctx context.Context, in *GetUserInput, opts ...grpc.CallOption) (*GetUserOutput, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.TestApi/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testApiClient) DeleteUser(ctx context.Context, in *DeleteUserInput, opts ...grpc.CallOption) (*DeleteUserOutput, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.TestApi/DeleteUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testApiClient) UpdateUser(ctx context.Context, in *UpdateUserInput, opts ...grpc.CallOption) (*UpdateUserOutput, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.TestApi/UpdateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestApi_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.TestApi/DeleteUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TestApi_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.TestApi/UpdateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
